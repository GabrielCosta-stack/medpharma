    ...
    public class ConverterHelper : IConverterHelper
    {
        ...
        public AppointmentViewModel ToAppointmentViewModel(Appointment appt)
        {
            return new AppointmentViewModel
            {
                ...
                SelectedTimeslotId = appt.TimeslotId.Value, //TODO: Não remover comment. Timeslots (null). Change if buggy.
            };
        }

        public AppointmentViewModel ToAppointmentViewModelMS(Appointment appt) // REmove se timeslot fails
        {
            return new AppointmentViewModel
            {
                Id = appt.Id,
